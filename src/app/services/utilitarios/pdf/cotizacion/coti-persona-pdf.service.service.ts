...
export class CotiPersonaPdfServiceService {
   ...
   */
  generarPDFCotizacion(data: any, preview: boolean): SafeResourceUrl | void {
    ...
    doc.setTextColor(0, 0, 0);
    doc.text(`${data.codCotizacion}`, xCot + ((xCot+anchoCampoCot-5)-xCot)/2, yCot + 3.5 + altoFilaCot, {align: 'center'});
